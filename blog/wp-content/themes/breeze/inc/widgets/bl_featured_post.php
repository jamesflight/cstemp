<?php
/*
Plugin Name: Bluthemes - Featured Posts
...
class bl_featured_post extends WP_Widget {
	...
	function bl_featured_post(){
		$this->WP_Widget('bl_featured_post', 'Bluthemes - Featured Post', array('classname' => 'bl_featured_post', 'description' => 'Display posts tagged with "featured" or the selected tag in Theme Options'));
	}
